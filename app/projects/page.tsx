...
import ModalProject from "../../lib/components/ModalProject";

export type ProjectDomain = 'research' | 'data' | 'UXUI' | 'fullstack' | 'user research';
...
const projects: Project[] = [
  ...
  },
  {
    ...
    domains: ['UXUI', 'fullstack', 'user research']
  },
  {
    id: 3,
    title: "Harshama Tova",
    ...
    domains: ['fullstack', 'user research']
  },
  {
    id: 4,
    ...
    domains: ['fullstack', 'UXUI', 'user research']
  },
  {
    id: 5,
    title: "The Influence of background colors on questionnaire responses - Research Project",
    ...
    domains: ['research', 'UXUI']
  },
  {
    id: 6,
    title: "Age vs. Sleep Duration Statistical Analysis - Research Project",
  ...
  {
    id: 7,
    title: "Israeli Patent Ecosystem Analysis & Classification - Research Project",
